<%@ Page Title="" Language="C#" MasterPageFile="~/mods/masterPageContent/ContentMasterPage.master" AutoEventWireup="true" CodeFile="ManageMenu.aspx.cs" Inherits="mods_general_ManageMenu" %>
		    ...
		    <div class="box">
			    <div class="box-header">
				    <div class="box-name">
					    ...
					    <span>Configuracion del Menu (Usuario depenendencia)</span>
				    </div>
				    <div class="box-icons">
			    ...
			    <div class="box-content">
				    ...
				    <div class="form-horizontal" role="form">
					    ...
					    <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <asp:Button ID="btnUpdate" runat="server" Text="Actualizar" class="btn btn-primary btn-label-left" Enabled="False" OnClick="btnUpdate_Click"    />
						    </div>
					    </div>
                    </div>
