			    ...
			    <div class="box-content">
				    ...
				    <div class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
						        <label class="col-sm-2 control-label" for="form-styles">Slider</label>
						        <div class="col-sm-10">								      
						            <uc1:ucMultiFileUpload ID="ucMultiFileUpload" runat="server" />	
                                    <asp:Button ID="btnUploadImage" runat="server" Text="Subir Imagenes" OnClick="btnUploadImage_Click" />					      
						        </div>
					        </div>
                         <div  class="form-group">
                              <label class="col-sm-2 control-label" for="form-styles">Imagenes</label>
