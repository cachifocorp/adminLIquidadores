<%@ Page Title="" Language="C#" MasterPageFile="~/mods/masterPageContent/ContentMasterPage.master" AutoEventWireup="true" CodeFile="offices.aspx.cs" Inherits="mods_general_offices" %>
	    ...
	    <div class="col-xs-12 col-sm-12">
		    <div class="box">
			    ...
			    <div class="box-content">
				    <h4 class="page-header">Registro de Oficinas</h4>
				    ...
				    <div class="form-horizontal" role="form">
                        <div class="form-group">
						    ...
						    <div class="col-sm-4">
							    <input type="text" id="txtFax" runat="server" class="form-control" placeholder="Nombre del telefono" data-toggle="tooltip" data-placement="bottom" title="Fax">
						    </div>
					    </div>
					    <div class="form-group">
