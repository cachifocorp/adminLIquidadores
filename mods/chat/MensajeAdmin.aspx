<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MensajeAdmin.aspx.cs" Inherits="mods_chat_Default" %>
	    ...
	    <div class="col-xs-12 col-sm-12">
		    <div class="box">
			    ...
			    <div class="box-content">
				    <h4 class="page-header">Finalización de Chat</h4>
                    <br />
                    &nbsp;
                    <br />
                    <h4>Su Sesión de Chat a finalizado por el usuario.</h4>
                    <br />
                    <h4>&nbsp;</h4>
