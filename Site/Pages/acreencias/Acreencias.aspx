<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Pages/masterPages/baseLine.master" AutoEventWireup="true" CodeFile="Acreencias.aspx.cs" Inherits="Pages_Products_Services" %>
	    ...
	    <div class="container">
		 <div class="row">
          ...
          <div class="page_title_inner">	      			       	
				...
				<span class="main_t_2">Comunicado notificaciones, calificación y graduación de acreencias.</span>				
		  </div>
		  </div>
		 </div>
        </div>			
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content_page" Runat="Server">
 ...
 <div class="container content_wrapper_section"> 
    <div class="container" id="pub_products" runat="server">
