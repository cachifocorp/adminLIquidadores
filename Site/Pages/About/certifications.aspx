<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/masterPages/baseLine.master" AutoEventWireup="true" CodeFile="certifications.aspx.cs" Inherits="Pages_About_certifications" %>
	    ...
	    <div class="container">
		 <div class="row">
          ...
          <div class="page_title_inner">	      			       	
				<span class="main_t_1"> CERTIFICACIONES </span>
				<span class="main_t_2"> AMV | Energia Y Comunicaciones </span>
				<span class="breadcrumb"> <a href="#">inicio </a> / CERTIFICACIONES </span>
		  </div>
		  </div>
		 </div>
        </div>			
...
<div class="container content_wrapper_section"> 
    <div class="container">
	  <div class="row">        							    
		<ul class="portfolio group" id="pub_certification" runat="server">  
		</ul>
