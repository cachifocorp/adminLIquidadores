<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Pages/masterPages/baseLine.master" AutoEventWireup="true" CodeFile="workWithUs.aspx.cs" Inherits="Pages_Contact_workWithUs" %>
	    ...
	    <div class="container">
		 <div class="row">
          ...
          <div class="page_title_inner">	      			       	
				<span class="main_t_1"> TRABAJE CON NOSOTROS </span>
				<span class="main_t_2"> Póngase en contacto con nuestra empresa </span>
				<span class="breadcrumb">
                      <a href="../Default.aspx">Inicio </a> / TRABAJE CON NOSOTROS </span>
		  </div>
		  </div>
		 </div>
        </div>			
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content_page" Runat="Server">
      ...
      <div class="row">
               <div class="span12">        	
                    ...
                    <h2 class="contact_text">¡Regístrese!</h2>               					
		       </div>
				<div class="clear"></div>
         <div id="label_Message" runat="server">              
        </div>
		<form class="contact_form contact_form_h"   style="margin-bottom: 10px;" runat="server">
