<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Pages/masterPages/baseLine.master" AutoEventWireup="true" CodeFile="guia.aspx.cs" Inherits="Pages_Products_Services" %>
	    ...
	    <div class="container">
		 <div class="row">
          ...
          <div class="page_title_inner">	      			       	
				<span class="main_t_1"> GUIA </span>
				<span class="main_t_2"> Guía del proceso liquidatorio </span>				
		  </div>
		  </div>
		 </div>
        </div>			
