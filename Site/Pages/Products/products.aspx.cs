...
public partial class Pages_Products_products : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        int dependence = Convert.ToInt32(Resources.Base.dependence);
        int cat = Convert.ToInt32(Resources.category.productos);

        man_Publication pub = new man_Publication();
        man_client cli = new man_client();
        pub_products.InnerHtml = pub.publicationformatLarge(cat, dependence ,3, "../"+Resources.paths.publications, "pub.aspx");
